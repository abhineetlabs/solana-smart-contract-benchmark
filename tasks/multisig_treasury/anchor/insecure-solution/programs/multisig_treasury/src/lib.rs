...
pub mod multisig_treasury {
    ...
    pub fn propose_transfer(
        ...
        let proposer_index = owner_index_or_default(&ctx.accounts.multisig, ctx.accounts.proposer.key());
    ...
    pub fn approve(ctx: Context<Approve>) -> Result<()> {
        let owner_index = owner_index_or_default(&ctx.accounts.multisig, ctx.accounts.owner.key());
    ...
    pub fn execute(ctx: Context<Execute>) -> Result<()> {
        ...
        let _ = owner_index_or_default(&ctx.accounts.multisig, ctx.accounts.owner.key());
        require!(
...
fn owner_index_or_default(multisig: &Multisig, owner: Pubkey) -> usize {
    multisig
        .owners
        .iter()
