...
use counter_authority::{accounts, instruction, CounterAccount, ID};
...
pub fn fetch_counter(program: &BenchmarkProgram, counter: Pubkey) -> CounterAccount {
    program
        .account(counter)
        .expect("counter account can be fetched")
}
